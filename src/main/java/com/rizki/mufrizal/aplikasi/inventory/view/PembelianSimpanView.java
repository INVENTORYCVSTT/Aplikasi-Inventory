...
public class PembelianSimpanView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        simpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/add.png"))); // NOI18N
        ...
        tabelPembelianSementara.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        ...
        transaksi.setText("LakukanTransaksi");
    ...
    private void idBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_idBarangActionPerformed
        pembelianController.tampilkanIsiDataBarangBerdasarkanIdBarang();
    }//GEN-LAST:event_idBarangActionPerformed

    private void simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_simpanMouseClicked
        pembelianController.tambahPembelianSementara();
    }//GEN-LAST:event_simpanMouseClicked

    private void transaksiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_transaksiMouseClicked
        pembelianController.simpanTransaksi();
